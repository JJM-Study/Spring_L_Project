...
public class BusinessExceptionAPITest {
    ...
    void orderExceptionJsonTest() throws Exception {
        ...
        BusinessException mockException = new BusinessException(ErrorCode.STOCK_NOT_ENOUGH_DETAIL);
        ...
        mockMvc.perform(post("/order/order_prod")
                ...
                .andExpect(jsonPath("$.errorCode").value("STOCK_NOT_ENOUGH_DETAIL"));
